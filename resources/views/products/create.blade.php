...
@section('body')
    ...
    <div class="container grid place-content-center my-5">
        <h1 class="text-5xl font-bold ">Create Product</h1>
    </div>
    ...
    <div class="container mx-auto mt-8">
      <form action="{{ route('products.store') }}" method="post" class="max-w-xl mx-auto p-6 bg-white rounded-md shadow-md" enctype="multipart/form-data">
          @csrf
          ...
          <div class="mb-4">
            ...
            <textarea id="message" name="description" rows="4" class="mt-1 p-2 w-full border rounded-md" >{{old('description')}}</textarea>
